...
class TransactionController {
    ...
    def save(Transaction transactionInstance) {
        ...
        transactionService.performTransaction(transactionInstance)
//        try {
//            TransactionService.performTransaction(transactionInstance.sender, transactionInstance.receiver, transactionInstance.amount)
//        }
//        catch(e) {
//            request.withFormat {
//                form multipartForm {
