	...
	<body>
		...
		<div id="show-person" class="content scaffold-show" role="main">
			...
			<ol class="property-list person">
				...
				<li class="fieldcontain">
					<span id="balance-label" class="property-label"><g:message code="person.balance.label" default="Balance" /></span>
					
						<span class="property-value" aria-labelledby="balance-label"><g:fieldValue bean="${personInstance}" field="balance"/></span>
				...
				<li class="fieldcontain">
					<span id="transactions-label" class="property-label"><g:message code="person.transactions.label" default="Transactions" /></span>
					
						<g:each in="${personInstance.transactions}" var="t">
						<span class="property-value" aria-labelledby="transactions-label"><g:link controller="txn" action="show" id="${t.id}">${t?.encodeAsHTML()}</g:link></span>
						</g:each>
